# RULES.md — Standing Rules (Never Skip)
...
## Captions & Mentions
- Model/assistant names (M: @handle) should be included if approved.
- Always verify model consent before tagging in public posts.
- Ronnie edits/approves captions before publishing.

---

## Reel & Story Protocols
- **Reel music:** Use official IG audio library for algorithm boost (no uploaded MP3 unless critical).
- **Story teaser:** Aesthetic/mood only — no "comeback narrative" unless Ronnie requests it.
- **Lighting diagrams:** Do not publish until professional quality (currently shelved).

---

**Last Updated:** 2026-03-12  
**Owner:** Echo (guided by Ronnie)  
**Enforcement:** Read this file before every caption/post task.
