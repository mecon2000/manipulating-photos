...
def create_job(resource_id, style_prompt, width, height):
    url = f"{BASE_URL}/jobs"
    headers = {"Authorization": f"Bearer {TENSOR_API_KEY}", "Content-Type": "application/json"}
    # REMOVED "Caucasian woman" from prompt
...
def main():
    ...
    batch = [
        {"path": "batch_photo_1.jpg", "name": "Mickey", "orig_rel": "Mickey/1 just Mickey,her house/Unprocessed photos/BLD_4471.jpg"},
        {"path": "batch_photo_2.jpg", "name": "Zohar_Asher", "orig_rel": "Zohar & Asher/Unprocessed/2 Outdoors Unprocessed/BLD_3481 - UNPROCESSED.jpg"}
    ]
