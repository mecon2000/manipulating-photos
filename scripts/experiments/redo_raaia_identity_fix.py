...
PHOTO_PATH = "/tmp/BLD_6662.jpg"
STYLE_PROMPT = "heavy swirling smoke, nebula, stars, space, deep colors, artistic figure photography"
...
STRENGTH = 0.55
OUTPUT_DIR = "outputs/raaia_identity_fix/"
        ...
        if url:
            ...
            if "Fal_Flux" in name:
                ...
                if swap_url:
                    ...
                    swap_filename = f"Raaia_Method_4_Fal_FaceSwap_on_Flux.jpg"
