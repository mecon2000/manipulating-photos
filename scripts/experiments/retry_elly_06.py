...
def main():
    ...
    full_prompt = f"artistic figure photography, high quality, consistent facial features, natural body shape, {style_prompt}, masterpiece."
    headers = {"Authorization": f"Bearer {TENSOR_API_KEY}", "Content-Type": "application/json"}
    ...
    for i in range(2):
        ...
        while True:
            ...
            if status == "SUCCESS":
                ...
                filename = f"Elly_Smoke_Mirrors_06_Likeness_{i+1}.png"
