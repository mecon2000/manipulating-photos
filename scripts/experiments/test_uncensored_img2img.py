        ...
        "stages": [
            ...
            },
            {
                ...
                "diffusion": {
                    "width": 1024,
                    "height": 1024,
                    "prompts": [{"text": "Professional fine art photography of a woman in a bathtub, Earthy Ochre and Clay style."}],
                    "sdModel": "965126062386242266", # Uncensored
                    "steps": 30,
                    "cfgScale": 7,
...
if resource_id:
    ...
    # Strength 0.15
    job_id = create_job(resource_id, 0.15)
    if job_id:
        print(f"Job ID: {job_id}")
        url = wait_for_job(job_id)
        print(f"JENIA_UNCENSORED_RESULT: {url}")
